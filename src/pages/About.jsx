...
durante anos,<br /> atuando como instrutor <br /> de break dance ate vir a pademia</p>
<img src={bboy} width={200} alt="bboy" />
</div>

<div className="about-card"><p>na pandemia ficou impossivel atuar <br /> e foi onde eu conheci a trybe <br />
